...
public class Test {
	...
	// 接口帐号
	private static final String account = "1001@501351060001";
	
	// 接口密钥
	private static final String authkey = "5C9D34049BD37607AAEF1C33E419CEEF";
	...
	public static void main(String[] args) throws Exception
	{
		...
		*/
		...
		List<SendResultBean> listItem = sendOnce("18633681107", "Java接口测试内容");
		if(listItem != null)
		{
