  ...
  <div class="layui-form-item" style="margin-bottom: 0px;">
     <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input name="roleName" id="roleName" type="text" lay-verify="" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-inline" id="search">
    	<div style="width:auto;" class="layui-input-inline">
      		<button class="layui-btn" lay-submit=""  lay-filter="formDemo">查询</button>
      		<a class="layui-btn" href="javascript:newrole()" >新建</a>
      	</div>
    </div>
  </div>
</blockquote>
	...
	var layer = layui.layer;
  		 $.ajax({
				...
				success:function(data){
					if(data==0){
						$.ajax({
							url:"<%=basePath %>roleauthority/del",
							dataType:"text",
							type:"post",
							data:{"roleId":id},
							success:function(data){
