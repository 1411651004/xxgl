					    ...
					    <div class="layui-colla-content layui-show">
							...
							<div class="layui-form-item">
							  <div class="layui-inline">
							    ...
							    <div class="layui-input-inline" style="width: 200px;">
							      <input type="text" readonly="readonly" name="zy" value="日本语专攻" id="zy" lay-verify="required" placeholder="请输入专业" autocomplete="off" class="layui-input">
							    </div>
							  </div>
							  <div class="layui-inline">
...
layui.use(['upload','jquery','layer','form','element','laydate'], function(){
	var $ = layui.jquery;
	var form = layui.form;
		 ...
		 $.ajax({
			...
			success:function(data){
							...
							if(data=='1'){
								layer.msg("保存成功");
								setTimeout(function(){
									location.href="<%=basePath%>xsxx/list?sta=2";
								},1500);
							}
