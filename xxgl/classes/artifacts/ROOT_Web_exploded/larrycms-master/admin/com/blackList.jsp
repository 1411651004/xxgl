  ...
  <div class="layui-form-item" style="margin-bottom: 0px;">
    ...
    <div class="layui-inline" id="search" style="margin-left:20px;">
    	<div style="width:auto;" class="layui-input-inline">
 			...
 			<a style="margin-left:20px;" class="layui-btn" href="javascript:void(0)" onclick="whiteForBatList('com/white','com/getBlackList');">撤销</a>
      	</div>
    </div>
    </div>
  </div>
...
<div id="dataList">
			<jsp:include page="getBlackList.jsp" />
</div>

 <jsp:include page="../common/page-ajax.jsp">
		<jsp:param name="url" value="com/getBlackList" />
</jsp:include>
  </body>
  <script>
