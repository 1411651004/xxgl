  ...
  <div class="layui-form-item" style="margin-bottom: 0px;">
    ...
    <div class="layui-inline" id="search" style="margin-left:20px;">
    	<div style="width:auto;" class="layui-input-inline">
 			...
 			<a style="margin-left:20px;" class="layui-btn" href="javascript:void(0)" onclick="delForBatList('com/delete','com/getCooList');">删除</a>
			<a style="margin-left:20px;" class="layui-btn" href="javascript:void(0)" onclick="addBlackList();">加入黑名单</a>
      		<a style="margin-left:20px;" class="layui-btn" href="<%=basePath %>com/exp">导出excel</a>
      	</div>
    </div>
    </div>
  </div>
...
<div id="dataList">
			<jsp:include page="getCooList.jsp" />
</div>

 <jsp:include page="../common/page-ajax.jsp">
		<jsp:param name="url" value="com/getCooList" />
</jsp:include>
  </body>
  <script>
