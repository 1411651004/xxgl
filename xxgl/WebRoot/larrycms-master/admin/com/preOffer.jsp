...
<div class="layui-form-item">
  ...
  <c:forEach var="filename" items="<%= filearr %>">  
...
<form class="layui-form" style="margin-left: 4%;margin-right: 4%;">
<fieldset class="layui-elem-field">
  <legend style="font-size:16px">报价信息</legend>
  <div class="layui-field-box">
 <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">承兑报价</label>
      <div class="layui-input-inline" style="width:198px">
        <input name="acceOffer" id="acceOffer" type="text" lay-verify="required|numberOrEmpty" autocomplete="off" class="layui-input">
      </div>
      <div class="layui-input-inline" style="width:80px">
	      <select name="acceOfferUnion" id="acceOfferUnion">
    ...
    <div class="layui-inline">
      <label class="layui-form-label">运费报价</label>
      <div class="layui-input-inline" style="width:198px">
        <input type="text" name="freOffer" id="freOffer" lay-verify="required|numberOrEmpty" autocomplete="off" class="layui-input">
      </div>
      <div class="layui-input-inline" style="width:80px">
        <select name="freOfferUnion" id="freOfferUnion">
			<option value="1">元</option>
			<option value="10000">万元</option>
		</select>
      </div>
 ...
 <div class="layui-form-item">
 	<div class="layui-inline">
     <label class="layui-form-label">现金报价</label>
     <div class="layui-input-inline" style="width:198px">
       <input name="cashOffer" id="cashOffer" type="text" lay-verify="required|numberOrEmpty" autocomplete="off" class="layui-input ">
     </div>
     <div class="layui-input-inline" style="width:80px">
       <select id="cashOfferUnion" name="cashOfferUnion">
			<option value="1">元</option>
			<option value="10000">万元</option>
		</select>
     </div>
...
<div class="layui-form-item">
    ...
    <input type="hidden" id="proId" name="proId" value="${project.id}"/>
