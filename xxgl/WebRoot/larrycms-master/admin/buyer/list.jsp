  ...
  <div class="layui-form-item" style="margin-bottom: 0px;">
     <div class="layui-inline">
      ...
      <input type="hidden" id="pageNum" name="pageNum">
        <input name="buyerName" id="buyerName" type="text" lay-verify="" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-inline" id="search">
    	<div style="width:auto;" class="layui-input-inline">
      		<button class="layui-btn" lay-submit=""  lay-filter="formDemo">查询</button>
      		<a class="layui-btn" href="javascript:newbuyer()" >新建</a>
      	</div>
    </div>
  </div>
</blockquote>
...
<div id="dataList">
 ...
 <jsp:include page="../common/page-ajax.jsp">
		<jsp:param name="url" value="buyer/getList" />
</jsp:include>
  </body>
  <script>
  function newbuyer(){
  	window.location.href="<%=basePath %>buyer/add?buyerId=0";
  }
  function updateBuyer(id){
  	window.location.href="<%=basePath %>buyer/add?buyerId="+id;
  }
